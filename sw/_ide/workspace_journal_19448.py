...
status = domain.set_config(option = "lib", param = "lwip220_stats", value = "true", lib_name="lwip220")
...
status = domain.set_config(option = "lib", param = "lwip220_udp_debug", value = "false", lib_name="lwip220")

status = domain.set_config(option = "lib", param = "lwip220_tcp", value = "false", lib_name="lwip220")

status = domain.set_config(option = "lib", param = "lwip220_pbuf_debug", value = "true", lib_name="lwip220")
